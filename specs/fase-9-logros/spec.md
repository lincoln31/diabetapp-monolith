...
- **[NECESITA ACLARACIÓN]** Catálogo de logros propuesto (6, ampliable después sin migración por ser código, no datos):
  ...
  ¿Apruebas esta lista o prefieres otros umbrales/categorías?
- **[NECESITA ACLARACIÓN]** Dónde se muestran: el issue #28 pide una **pantalla**, no una tarjeta del dashboard. Propuesta: pantalla dedicada «Mis Logros» con un botón de acceso en el dashboard (mismo patrón que «Mi perfil»), sin tarjeta-resumen en el dashboard por ahora (se puede agregar después sin romper nada, es una pieza más de la lista de tarjetas). ¿De acuerdo?
